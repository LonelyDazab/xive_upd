...
if(mobaimed == true) {	if(Utils.Friends.isFriend(mobs[i])) {
									small = dist;
						     ent = mobs[i]
						    }else {
									continue;
...
if(playaimed == true) {	if(Utils.Friends.isFriend(players[i])) {
									small = dist;
									ent = players[i];
...
var exitM = new Button(ctx);
      ...
      jatpack = true;
			...
			var pau = new Button(ctx);
			pau.setText("Parcour");
			pau.setTextColor(android.graphics.Color.rgb(255, 255, 255));
			pau.setPadding(25, 2, 2, 2);
			if(parcour == false) {
			pau.setBackground(bg2);
			}else {
			pau.setBackground(bg3);
			}
			pau.getBackground().setAlpha(100);
...
if(parcour == true) {
if(getTile(getPlayerX(), getPlayerY()-2, getPlayerZ()) == 0 && getTile(getPlayerX(), getPlayerY()-3, getPlayerZ()) == 0 && getTile(getPlayerX(), getPlayerY()-4, getPlayerZ()) == 0 && !Utils.Player.onGround()/* && Utils.Player.isFalling()*/) {

//if(getVelY(getPlayerEnt()) > 0.9) {
if(this.xpos != null) {
setPosition(getPlayerEnt(), xpos, ypos, zpos);
//clientMessage("setBack");
//}
}


}else {
this.xpos = getPlayerX();
this.ypos = getPlayerY();
this.zpos = getPlayerZ();
